    ...
    return (
        <>
            ...
            <div className='flex h-full w-full'>
                <Sidebar />
                <div className=' rounded-tl-lg  flex flex-col justify-center items-center h-screen w-screen bg-slate-200'>
                    <TextField
                        class='rounded-tl-2xl rounded-br-2xl mt-20 bg-slate-400'
                        hiddenLabel
                    ...
                    <div className="flex items-center justify-center flex-grow">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                            <div classname="flex items-center justify-center min-h-screen container mx-auto">
                                <div className='bg-slate-50 m-1 rounded-xl shadow-lg'>
                                    <div className='p-5 flex flex-col'>
                                        ...
                                        <p className='text-slate-600 text-lg mb-1 mt-3'> tipo de solicitud </p>
                                        <div className='flex'>
