            ...
            <div className='flex h-full w-full m-auto bg-gradient-to-r from-blue-800 via-blue-200 to-cyan-500'>
                ...
                <h1 className=' font-bold' >Datos solicidatos durante el año 2024</h1>
                    <table>
                        <thead>
                            <tr >
                                <th scope='col' className=' mr-3 p-4    border-4 border-double border-black '>nombre </th>
                                <th scope='col' className=' mr-3 p-4    border-4 border-double border-black'>tipo de solicitud </th>
                                <th scope='col' className=' mr-3 p-4    border-4 border-double border-black'> fecha solicitada </th>
                                <th scope='col' className=' mr-3 p-4    border-4 border-double border-black '> dias restantes </th>
                            </tr>
                        </thead>
                        ...
                        <tbody >
                            <tr className=' justify-between '>
                                <th scope='row' className=' p-1 border-4 border-gray-900 text-slate-800'> jose </th>
